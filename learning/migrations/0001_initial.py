    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Описание появится в скором времени', verbose_name='Описание курса')),
            ],
            options={
                'verbose_name': 'Курс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='Название не указано', max_length=120, verbose_name='Название урока')),
                ('description', models.TextField(default='Описание появится в скором времени', verbose_name='Описание урока')),
                ('image', models.ImageField(blank=True, null=True, upload_to='learning/', verbose_name='Первью')),
